...
description: "CRITICAL: Use for Makepad animation system. Triggers on: makepad animation,\
  \ makepad animator, makepad hover, makepad state, makepad transition, \"from: {\
  \ all: Forward\", makepad pressed, makepad \u52A8\u753B, makepad \u72B6\u6001, makepad\
  \ \u8FC7\u6E21, makepad \u60AC\u505C\u6548\u679C"
---
