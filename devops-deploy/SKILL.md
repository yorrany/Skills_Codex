---
name: devops-deploy
description: "DevOps e deploy de aplicacoes \u2014 Docker, CI/CD com GitHub Actions,\
  \ AWS Lambda, SAM, Terraform, infraestrutura como codigo e monitoramento. Ativar\
  \ para: dockerizar aplicacao, configurar pipeline..."
---
