---
name: earllm-build
description: "Build, maintain, and extend the EarLLM One Android project \u2014 a\
  \ Kotlin/Compose app that connects Bluetooth earbuds to an LLM via voice pipeline.\
  \ Use this skill whenever working on the earbudllm..."
---
